...
export const mockBlogPost: MockBlogPost = {
    id: "1",
    title: "Welcome to Radio Comunitaria",
    slug: "welcome-to-radio-cesar",
    content:
        "This is our first blog post about Radio Comunitaria community platform...",
    excerpt: "Introduction to Radio Comunitaria",
    authorId: "1",
 ...
 */
export function createMockDonation(
