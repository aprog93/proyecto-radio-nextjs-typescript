...
const programsPreview = [
    {
        id: "termometro",
        name: "El Termómetro",
        format: "Encuesta callejera y sondeo de opinión radiofónico",
        meta: "Diagnosticar democráticamente las prioridades de la comunidad",
        schedule: "Lun-Mié 10:00-11:00",
    },
    {
        id: "sin-filtro",
        name: "Sin Filtro",
        format: "Panel de jóvenes con agenda libre",
        meta: "Plataforma auténtica para que la juventud hable de lo que le importa",
        schedule: "Jue 16:00-17:30",
    },
    {
        id: "deporte-total",
        name: "Deporte Total",
        format: "Narración deportiva local",
        meta: "Celebrar el deporte como espacio de cohesión social",
        schedule: "Sáb-Dom 14:00-16:00",
    },
];
    ...
    return (
        <div>
            ...
            <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
                ...
                <button
                    onClick={prev}
                    className="absolute left-4 z-20 p-2 rounded-full bg-background/50 text-foreground hover:bg-background/80 transition-colors"
                ...
                <button
                    onClick={next}
                    className="absolute right-4 z-20 p-2 rounded-full bg-background/50 text-foreground hover:bg-background/80 transition-colors"
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Contenido próximamente cuando se conecte
                                        el CMS.
                                    </p>
                                </div>
                            </div>
